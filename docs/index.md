...
The JSON Schemas bundled in the Python package are also published with the
documentation site under `https://pheat.tools.blankenberglab.org/schemas/`.
Those public URLs are used as the schema `$id` namespace.
